...
<html lang="en">
  ...
  <head>
    ...
    <title>MoratMarit | Halaman Beranda</title>
...
<p>
          ...
          <b>Di Unggah Oleh </b> <?php echo htmlentities($row['postedBy']);?> Di </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Terakhir Diperbaharui Oleh </b> <?php echo htmlentities($row['lastUpdatedBy']);?> Di </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
...
<a href="https://www.linkedin.com/in/muhammad-annas-darunnaja-3839a5247?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app=<?php echo $currenturl;?>" target="_blank">Linkedin</a>  <b>Visits:</b> <?php print $visits; ?>
                </p>
                <hr />
